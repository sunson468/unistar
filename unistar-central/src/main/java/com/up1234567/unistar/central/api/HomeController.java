...
public class HomeController {
    ...
    public BaseOutModel dashstat(@RequestAttribute(AuthToken.REQ_AUTH) AuthToken authToken, @RequestBody BaseInModel inModel) {
        ...
        retModel.setData(CollectionUtils.union(statTraceService.passedDayStatTotals(inModel.getNamespace(), 30), statTraceService.todayStatTotals(inModel.getNamespace())));
        retModel.setRetCode(BaseOutModel.RET_OK);
        return retModel;
    }
